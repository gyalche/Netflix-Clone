  ...
  return (
    <div className="bg-dry py-4 border=t-2 border-black">
      <div className="container mx-auto px-2">
        <div className="grid grid-cols-2 lg:grid-cols-7 md:grid-cols-4 md:ml-20 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 py-10 justify-between">
          ...
          <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3">
            ...
            <p className="leading-7 text-sm text-border mt-3">
              Lorem 196 Gokarna Road, Hanumanwochk, BasnetGow
            </p>
            <br />
            <span>Tell:+977 9803850359</span>
            <br />
            <span>Email:sherpadawag1998@gmail.com</span>
          </div>
        </div>
      </div>
    </div>
